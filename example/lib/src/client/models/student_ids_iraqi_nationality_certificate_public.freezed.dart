...
StudentIdsIraqiNationalityCertificatePublic
    _$StudentIdsIraqiNationalityCertificatePublicFromJson(
        Map<String, dynamic> json) {
  return _StudentIdsIraqiNationalityCertificatePublic.fromJson(json);
}
...
mixin _$StudentIdsIraqiNationalityCertificatePublic {
  ...
  /// Serializes this StudentIdsIraqiNationalityCertificatePublic to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of StudentIdsIraqiNationalityCertificatePublic
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $StudentIdsIraqiNationalityCertificatePublicCopyWith<
          StudentIdsIraqiNationalityCertificatePublic>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StudentIdsIraqiNationalityCertificatePublicCopyWith<$Res> {
  factory $StudentIdsIraqiNationalityCertificatePublicCopyWith(
          StudentIdsIraqiNationalityCertificatePublic value,
          $Res Function(StudentIdsIraqiNationalityCertificatePublic) then) =
      _$StudentIdsIraqiNationalityCertificatePublicCopyWithImpl<$Res,
          StudentIdsIraqiNationalityCertificatePublic>;
  @useResult
  $Res call(
...
/// @nodoc
class _$StudentIdsIraqiNationalityCertificatePublicCopyWithImpl<$Res,
        $Val extends StudentIdsIraqiNationalityCertificatePublic>
    implements $StudentIdsIraqiNationalityCertificatePublicCopyWith<$Res> {
  _$StudentIdsIraqiNationalityCertificatePublicCopyWithImpl(
...
/// @nodoc
abstract class _$$StudentIdsIraqiNationalityCertificatePublicImplCopyWith<$Res>
    implements $StudentIdsIraqiNationalityCertificatePublicCopyWith<$Res> {
  factory _$$StudentIdsIraqiNationalityCertificatePublicImplCopyWith(
          _$StudentIdsIraqiNationalityCertificatePublicImpl value,
          $Res Function(_$StudentIdsIraqiNationalityCertificatePublicImpl)
              then) =
      __$$StudentIdsIraqiNationalityCertificatePublicImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'number') String? number,
...
/// @nodoc
class __$$StudentIdsIraqiNationalityCertificatePublicImplCopyWithImpl<$Res>
    extends _$StudentIdsIraqiNationalityCertificatePublicCopyWithImpl<$Res,
        _$StudentIdsIraqiNationalityCertificatePublicImpl>
    implements
        _$$StudentIdsIraqiNationalityCertificatePublicImplCopyWith<$Res> {
  __$$StudentIdsIraqiNationalityCertificatePublicImplCopyWithImpl(
      _$StudentIdsIraqiNationalityCertificatePublicImpl _value,
      $Res Function(_$StudentIdsIraqiNationalityCertificatePublicImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$StudentIdsIraqiNationalityCertificatePublicImpl(
      number: freezed == number
          ? _value.number
          : number // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$StudentIdsIraqiNationalityCertificatePublicImpl
  ...
  @override
  String toString() {
    return 'StudentIdsIraqiNationalityCertificatePublic(number: $number, walletNumber: $walletNumber, issuingAuthority: $issuingAuthority, dateOfIssue: $dateOfIssue, frontImage: $frontImage, backImage: $backImage)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$StudentIdsIraqiNationalityCertificatePublicImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, number, walletNumber,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$StudentIdsIraqiNationalityCertificatePublicImplCopyWith<
          _$StudentIdsIraqiNationalityCertificatePublicImpl>
      get copyWith =>
          __$$StudentIdsIraqiNationalityCertificatePublicImplCopyWithImpl<
                  _$StudentIdsIraqiNationalityCertificatePublicImpl>(
  ...
  Map<String, dynamic> toJson() {
    return _$$StudentIdsIraqiNationalityCertificatePublicImplToJson(
      this,
    );
  }
}
