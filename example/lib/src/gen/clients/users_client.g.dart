...
class _UsersClient implements UsersClient {
  ...
  Future<HttpResponse<UsersPublic>> usersReadUsers({
    required UsersReadUsersQueries queries,
  }) async {
    ...
    final _options = _setStreamType<HttpResponse<UsersPublic>>(
    ...
    late UsersPublic _value;
    try {
      _value = UsersPublic.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<HttpResponse<UserPublic>> usersReadUserMe() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<Message>> usersDeleteUserMe() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
