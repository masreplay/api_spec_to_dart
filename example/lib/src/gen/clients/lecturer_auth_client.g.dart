...
part of 'lecturer_auth_client.dart';
...
class _LecturerAuthClient implements LecturerAuthClient {
  _LecturerAuthClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<HttpResponse<LecturerAuthResponse>> lecturerAuthLogin(
    ...
    final _options = _setStreamType<HttpResponse<LecturerAuthResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    late LecturerAuthResponse _value;
    try {
      _value = LecturerAuthResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<LecturerAuthResponse>> lecturerAuthSwaggerLogin(
    ...
    final _options = _setStreamType<HttpResponse<LecturerAuthResponse>>(Options(
      ...
      contentType: 'application/x-www-form-urlencoded',
        ...
        .compose(
          _dio.options,
          '/api/v1/lecturer/auth/swagger/login',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<LecturerAuthResponse?>> lecturerAuthRefreshToken(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/v1/lecturer/auth/refresh_token',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    try {
      _value = _result.data == null
          ? null
          : LecturerAuthResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
