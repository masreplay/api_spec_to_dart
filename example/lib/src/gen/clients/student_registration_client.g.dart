...
part of 'student_registration_client.dart';
...
class _StudentRegistrationClient implements StudentRegistrationClient {
  ...
  Future<HttpResponse<BaseResponseStudentPersonalInfoResponse>>
    ...
    final _options =
      ...
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  '/api/v1/student/registration/personal',
  ...
  Future<HttpResponse<BaseResponseUnionStudentSchoolInfoResponse>>
    ...
    final _options = _setStreamType<
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/student/registration/school',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<BaseResponseMessageResponse>>
    ...
    _data.addAll(body.toJson());
    final _options =
        _setStreamType<HttpResponse<BaseResponseMessageResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/v1/student/registration/ids/foreigner',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponseMessageResponse _value;
    try {
      _value = BaseResponseMessageResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<BaseResponseMessageResponse>>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/v1/student/registration/ids/identity_card',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<BaseResponseMessageResponse>>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/v1/student/registration/ids/nationality_card',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
