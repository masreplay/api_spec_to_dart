...
part of 'student_verification_client.dart';
...
class _StudentVerificationClient implements StudentVerificationClient {
  ...
  Future<HttpResponse<BaseResponseListVerificationMethodPublic>>
      studentVerificationInitOtpData() async {
  ...
  Future<HttpResponse<MessageResponse>> studentVerificationVerifyOtp(
    ...
    final _options = _setStreamType<HttpResponse<MessageResponse>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/student/auth/otp/verify',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
