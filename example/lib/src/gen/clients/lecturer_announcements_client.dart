...
abstract class LecturerAnnouncementsClient {
  ...
  Future<HttpResponse<dynamic>>
      lecturer_announcements_get_lecturer_announcements();
  ...
  Future<HttpResponse<dynamic>>
      lecturer_announcements_get_lecturer_announcement();

  /// null
  @GET('/api/v1/lecturer/announcements/{id}/comments')
  Future<HttpResponse<dynamic>>
      lecturer_announcements_get_lecturer_announcement_comments();
}
