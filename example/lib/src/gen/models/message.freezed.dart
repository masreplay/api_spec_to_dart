...
/// message
@JsonKey(name: Message.messageKey) String get message;
...
@useResult
$Res call({
@JsonKey(name: Message.messageKey) String message
});
...
class _Message extends Message {
  const _Message({@JsonKey(name: Message.messageKey) required this.message}): super._();
  factory _Message.fromJson(Map<String, dynamic> json) => _$MessageFromJson(json);

/// message
@override@JsonKey(name: Message.messageKey) final  String message;
