...
mixin _$PaginationResponseStudentNotificationsPublic {
  ...
  /// Data
  @JsonKey(name: 'data')
  List<StudentNotificationsPublic> get data =>
...
abstract class $PaginationResponseStudentNotificationsPublicCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'data') List<StudentNotificationsPublic> data});
}
    ...
    return _then(_value.copyWith(
      ...
      data: null == data
          ...
          : data // ignore: cast_nullable_to_non_nullable
              as List<StudentNotificationsPublic>,
    ) as $Val);
  }
}
...
class _$PaginationResponseStudentNotificationsPublicImpl
  ...
  const _$PaginationResponseStudentNotificationsPublicImpl(
      ...
      @JsonKey(name: 'data')
      required final List<StudentNotificationsPublic> data})
      : _data = data,
        super._();
  ...
  /// Data
  final List<StudentNotificationsPublic> _data;
