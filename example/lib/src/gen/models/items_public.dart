...
abstract class ItemsPublic with _$ItemsPublic {
  ...
  const factory ItemsPublic({
    /// data
    @JsonKey(name: ItemsPublic.dataKey) required List<ItemPublic> data,

    /// count
    @JsonKey(name: ItemsPublic.countKey) required int count,
  }) = _ItemsPublic;

  factory ItemsPublic.fromJson(Map<String, dynamic> json) =>
      _$ItemsPublicFromJson(json);
  const ItemsPublic._();
