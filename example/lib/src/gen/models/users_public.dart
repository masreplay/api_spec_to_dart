...
/// data
@JsonKey(name: UsersPublic.dataKey)
required List<UserPublic> data,/// count
@JsonKey(name: UsersPublic.countKey)
required int count,  }) = _UsersPublic;

  factory UsersPublic.fromJson(
    Map<String, dynamic> json,
  ) => _$UsersPublicFromJson(
    json,
  );
}
