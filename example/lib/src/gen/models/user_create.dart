...
abstract class UserCreate with _$UserCreate {
  ...
  const factory UserCreate({
    ...
    /// is_active
    @Default(true) @JsonKey(name: UserCreate.isActiveKey) bool isActive,

    /// is_superuser
    @Default(false) @JsonKey(name: UserCreate.isSuperuserKey) bool isSuperuser,

    /// Full Name
    @JsonKey(name: UserCreate.fullNameKey) required Stringdynamic? fullName,
