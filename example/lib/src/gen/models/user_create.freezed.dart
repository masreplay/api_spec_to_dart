...
/// email
@JsonKey(name: UserCreate.emailKey) String get email;/// is_active
@JsonKey(name: UserCreate.isActiveKey) bool get isActive;/// is_superuser
@JsonKey(name: UserCreate.isSuperuserKey) bool get isSuperuser;/// Full Name
@JsonKey(name: UserCreate.fullNameKey) Stringdynamic? get fullName;/// password
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,email,isActive,isSuperuser,const DeepCollectionEquality().hash(fullName),password);

@override
String toString() {
  return 'UserCreate(email: $email, isActive: $isActive, isSuperuser: $isSuperuser, fullName: $fullName, password: $password)';
}
...
@useResult
$Res call({
@JsonKey(name: UserCreate.emailKey) String email,@JsonKey(name: UserCreate.isActiveKey) bool isActive,@JsonKey(name: UserCreate.isSuperuserKey) bool isSuperuser,@JsonKey(name: UserCreate.fullNameKey) Stringdynamic? fullName,@JsonKey(name: UserCreate.passwordKey) String password
});
...
/// Create a copy of UserCreate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? isActive = null,Object? isSuperuser = null,Object? fullName = freezed,Object? password = null,}) {
...
as Stringdynamic?,password: null == password ? _self.password : password // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _UserCreate extends UserCreate {
  const _UserCreate({@JsonKey(name: UserCreate.emailKey) required this.email, @JsonKey(name: UserCreate.isActiveKey) this.isActive = true, @JsonKey(name: UserCreate.isSuperuserKey) this.isSuperuser = false, @JsonKey(name: UserCreate.fullNameKey) required this.fullName, @JsonKey(name: UserCreate.passwordKey) required this.password}): super._();
...
/// is_active
@override@JsonKey(name: UserCreate.isActiveKey) final  bool isActive;
/// is_superuser
@override@JsonKey(name: UserCreate.isSuperuserKey) final  bool isSuperuser;
/// Full Name
@override@JsonKey(name: UserCreate.fullNameKey) final  Stringdynamic? fullName;
/// password
...
/// Create a copy of UserCreate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? isActive = null,Object? isSuperuser = null,Object? fullName = freezed,Object? password = null,}) {
