...
abstract class UserPublic with _$UserPublic {
  ...
  const factory UserPublic({
    /// email
    @JsonKey(name: UserPublic.emailKey) required String email,

    /// is_active
    @Default(true) @JsonKey(name: UserPublic.isActiveKey) bool isActive,

    /// is_superuser
    @Default(false) @JsonKey(name: UserPublic.isSuperuserKey) bool isSuperuser,

    /// Full Name
    @JsonKey(name: UserPublic.fullNameKey) required Stringdynamic? fullName,

    /// id
    @JsonKey(name: UserPublic.idKey) required String id,
  }) = _UserPublic;
