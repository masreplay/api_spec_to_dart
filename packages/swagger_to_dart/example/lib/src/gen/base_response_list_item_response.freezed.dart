...
/// data
@JsonKey(name: BaseResponseListItemResponse.dataKey) List<AppGenericRouterItemResponse> get data;/// message
...
@useResult
$Res call({
@JsonKey(name: BaseResponseListItemResponse.dataKey) List<AppGenericRouterItemResponse> data,@JsonKey(name: BaseResponseListItemResponse.messageKey) String message,@JsonKey(name: BaseResponseListItemResponse.codeKey) int code
});
...
as List<AppGenericRouterItemResponse>,message: null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
...
class _BaseResponseListItemResponse extends BaseResponseListItemResponse {
  const _BaseResponseListItemResponse({@JsonKey(name: BaseResponseListItemResponse.dataKey) required final  List<AppGenericRouterItemResponse> data, @JsonKey(name: BaseResponseListItemResponse.messageKey) required this.message, @JsonKey(name: BaseResponseListItemResponse.codeKey) required this.code}): _data = data,super._();
  factory _BaseResponseListItemResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseListItemResponseFromJson(json);

/// data
 final  List<AppGenericRouterItemResponse> _data;
/// data
@override@JsonKey(name: BaseResponseListItemResponse.dataKey) List<AppGenericRouterItemResponse> get data {
