...
/// coordinate
@JsonKey(name: CoordinateModel.coordinateKey) dynamic get coordinate;/// latitude
...
@useResult
$Res call({
@JsonKey(name: CoordinateModel.coordinateKey) dynamic coordinate,@JsonKey(name: CoordinateModel.latitudeKey) double? latitude,@JsonKey(name: CoordinateModel.longitudeKey) double? longitude
});
...
/// coordinate
@override@JsonKey(name: CoordinateModel.coordinateKey) final  dynamic coordinate;
/// latitude
