...
/// data
@JsonKey(name: BaseResponseItemResponse.dataKey) AppGenericRouterItemResponse get data;/// message
...
@useResult
$Res call({
@JsonKey(name: BaseResponseItemResponse.dataKey) AppGenericRouterItemResponse data,@JsonKey(name: BaseResponseItemResponse.messageKey) String message,@JsonKey(name: BaseResponseItemResponse.codeKey) int code
});


$AppGenericRouterItemResponseCopyWith<$Res> get data;
...
as AppGenericRouterItemResponse,message: null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
...
$AppGenericRouterItemResponseCopyWith<$Res> get data {
  ...
  return $AppGenericRouterItemResponseCopyWith<$Res>(_self.data, (value) {
...
/// data
@override@JsonKey(name: BaseResponseItemResponse.dataKey) final  AppGenericRouterItemResponse data;
/// message
...
@override $AppGenericRouterItemResponseCopyWith<$Res> get data;
