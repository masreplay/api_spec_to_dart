...
/// ulid
@JsonKey(name: UlidModel.ulidKey) IntOrMultipartFileOrString get ulid;
...
@useResult
$Res call({
@JsonKey(name: UlidModel.ulidKey) IntOrMultipartFileOrString ulid
});
...
/// ulid
@override@JsonKey(name: UlidModel.ulidKey) final  IntOrMultipartFileOrString ulid;
