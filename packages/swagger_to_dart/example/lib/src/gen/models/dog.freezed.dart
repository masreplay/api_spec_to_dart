...
mixin _$Dog {
  /// name
  @JsonKey(name: Dog.nameKey_)
  String get name;

  /// type
  @JsonKey(name: Dog.typeKey_)
  String get type;

  /// barkLoudness
  @JsonKey(name: Dog.barkLoudnessKey_)
...
abstract mixin class $DogCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: Dog.nameKey_) String name,
      @JsonKey(name: Dog.typeKey_) String type,
      @JsonKey(name: Dog.barkLoudnessKey_) int barkLoudness});
}
...
class _Dog extends Dog {
  const _Dog(
      {@JsonKey(name: Dog.nameKey_) required this.name,
      @JsonKey(name: Dog.typeKey_) this.type = 'dog',
      @JsonKey(name: Dog.barkLoudnessKey_) required this.barkLoudness})
      : super._();
