...
mixin _$BodyFilesFileUpload {
  /// file
  @JsonKey(name: BodyFilesFileUpload.fileKey_)
  MultipartFile get file;

  /// description
  @JsonKey(name: BodyFilesFileUpload.descriptionKey_)
...
abstract mixin class $BodyFilesFileUploadCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: BodyFilesFileUpload.fileKey_) MultipartFile file,
...
class _BodyFilesFileUpload extends BodyFilesFileUpload {
  const _BodyFilesFileUpload(
      {@JsonKey(name: BodyFilesFileUpload.fileKey_) required this.file,
      @JsonKey(name: BodyFilesFileUpload.descriptionKey_) this.description})
      : super._();
