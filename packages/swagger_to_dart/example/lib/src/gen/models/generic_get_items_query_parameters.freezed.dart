...
abstract mixin class $GenericGetItemsQueryParametersCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: GenericGetItemsQueryParameters.pageKey_) int page,
      @JsonKey(name: GenericGetItemsQueryParameters.perPageKey_) int perPage});
}
...
class _GenericGetItemsQueryParameters extends GenericGetItemsQueryParameters {
  const _GenericGetItemsQueryParameters(
      {@JsonKey(name: GenericGetItemsQueryParameters.pageKey_) this.page = 1,
      @JsonKey(name: GenericGetItemsQueryParameters.perPageKey_)
      this.perPage = 10})
      : super._();
