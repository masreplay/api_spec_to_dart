...
mixin _$Coordinate {
  /// latitude
  @JsonKey(name: Coordinate.latitudeKey_)
  double get latitude;

  /// longitude
  @JsonKey(name: Coordinate.longitudeKey_)
...
abstract mixin class $CoordinateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: Coordinate.latitudeKey_) double latitude,
      @JsonKey(name: Coordinate.longitudeKey_) double longitude});
}
...
extension CoordinatePatterns on Coordinate {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: Coordinate.latitudeKey_) double latitude,
            @JsonKey(name: Coordinate.longitudeKey_) double longitude)?
        $default, {
    required TResult orElse(),
  }) {
...
class _Coordinate extends Coordinate {
  const _Coordinate(
      {@JsonKey(name: Coordinate.latitudeKey_) required this.latitude,
      @JsonKey(name: Coordinate.longitudeKey_) required this.longitude})
      : super._();
