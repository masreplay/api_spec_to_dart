...
mixin _$AllTypesWithValidation {
  /// intValue
  @JsonKey(name: AllTypesWithValidation.intValueKey_)
  int get intValue;
  ...
  /// urlValue
  @JsonKey(name: AllTypesWithValidation.urlValueKey_)
  Uri get urlValue;
...
abstract mixin class $AllTypesWithValidationCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: AllTypesWithValidation.intValueKey_) int intValue,
      @JsonKey(name: AllTypesWithValidation.floatValueKey_) double floatValue,
      @JsonKey(name: AllTypesWithValidation.strValueKey_) String strValue,
      @JsonKey(name: AllTypesWithValidation.boolValueKey_) bool boolValue,
      @JsonKey(name: AllTypesWithValidation.emailValueKey_) String emailValue,
      @JsonKey(name: AllTypesWithValidation.urlValueKey_) Uri urlValue,
      @JsonKey(name: AllTypesWithValidation.listValueKey_)
