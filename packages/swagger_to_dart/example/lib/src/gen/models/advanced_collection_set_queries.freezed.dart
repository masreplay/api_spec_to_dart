...
mixin _$AdvancedCollectionSetQueries {
  ...
  $AdvancedCollectionSetQueriesCopyWith<AdvancedCollectionSetQueries>
      get copyWith => _$AdvancedCollectionSetQueriesCopyWithImpl<
              AdvancedCollectionSetQueries>(
          this as AdvancedCollectionSetQueries, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdvancedCollectionSetQueries &&
...
abstract mixin class $AdvancedCollectionSetQueriesCopyWith<$Res> {
  factory $AdvancedCollectionSetQueriesCopyWith(
          AdvancedCollectionSetQueries value,
          $Res Function(AdvancedCollectionSetQueries) _then) =
      _$AdvancedCollectionSetQueriesCopyWithImpl;
  @useResult
  $Res call(
...
class _AdvancedCollectionSetQueries extends AdvancedCollectionSetQueries {
  const _AdvancedCollectionSetQueries(
      {@JsonKey(name: AdvancedCollectionSetQueries.itemsKey)
      final List<int> items = const [1, 2, 3]})
      : _items = items,
        super._();
  factory _AdvancedCollectionSetQueries.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdvancedCollectionSetQueriesCopyWith<_AdvancedCollectionSetQueries>
      get copyWith => __$AdvancedCollectionSetQueriesCopyWithImpl<
          _AdvancedCollectionSetQueries>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdvancedCollectionSetQueriesToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdvancedCollectionSetQueries &&
...
/// @nodoc
abstract mixin class _$AdvancedCollectionSetQueriesCopyWith<$Res>
    implements $AdvancedCollectionSetQueriesCopyWith<$Res> {
  factory _$AdvancedCollectionSetQueriesCopyWith(
          _AdvancedCollectionSetQueries value,
          $Res Function(_AdvancedCollectionSetQueries) _then) =
      __$AdvancedCollectionSetQueriesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: AdvancedCollectionSetQueries.itemsKey) List<int> items});
