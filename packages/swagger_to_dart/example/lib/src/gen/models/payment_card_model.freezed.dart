...
mixin _$PaymentCardModel {
  /// cardNumber
  @JsonKey(name: PaymentCardModel.cardNumberKey_)
  String get cardNumber;

  /// cardBrand
  @JsonKey(name: PaymentCardModel.cardBrandKey_)
...
abstract mixin class $PaymentCardModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: PaymentCardModel.cardNumberKey_) String cardNumber,
      @JsonKey(name: PaymentCardModel.cardBrandKey_)
...
class _PaymentCardModel extends PaymentCardModel {
  const _PaymentCardModel(
      {@JsonKey(name: PaymentCardModel.cardNumberKey_) required this.cardNumber,
      @JsonKey(name: PaymentCardModel.cardBrandKey_) this.cardBrand})
      : super._();
