...
mixin _$CategoryResponse {
  /// id
  @JsonKey(name: CategoryResponse.idKey_)
  int get id;

  /// name
  @JsonKey(name: CategoryResponse.nameKey_)
  String get name;
...
abstract mixin class $CategoryResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: CategoryResponse.idKey_) int id,
      @JsonKey(name: CategoryResponse.nameKey_) String name});
}
...
extension CategoryResponsePatterns on CategoryResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: CategoryResponse.idKey_) int id,
            @JsonKey(name: CategoryResponse.nameKey_) String name)?
        $default, {
    required TResult orElse(),
  }) {
...
class _CategoryResponse extends CategoryResponse {
  const _CategoryResponse(
      {@JsonKey(name: CategoryResponse.idKey_) required this.id,
      @JsonKey(name: CategoryResponse.nameKey_) required this.name})
      : super._();
