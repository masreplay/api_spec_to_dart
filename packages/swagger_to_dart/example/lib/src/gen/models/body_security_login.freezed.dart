...
mixin _$BodySecurityLogin {
  /// grantType
  @JsonKey(name: BodySecurityLogin.grantTypeKey_)
  String? get grantType;

  /// username
  @JsonKey(name: BodySecurityLogin.usernameKey_)
  String get username;

  /// password
  @JsonKey(name: BodySecurityLogin.passwordKey_)
  String get password;

  /// scope
  @JsonKey(name: BodySecurityLogin.scopeKey_)
  String get scope;

  /// clientId
  @JsonKey(name: BodySecurityLogin.clientIdKey_)
  String? get clientId;

  /// clientSecret
  @JsonKey(name: BodySecurityLogin.clientSecretKey_)
...
abstract mixin class $BodySecurityLoginCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: BodySecurityLogin.usernameKey_) String username,
      @JsonKey(name: BodySecurityLogin.passwordKey_) String password,
      @JsonKey(name: BodySecurityLogin.scopeKey_) String scope,
...
class _BodySecurityLogin extends BodySecurityLogin {
  const _BodySecurityLogin(
      {@JsonKey(name: BodySecurityLogin.grantTypeKey_) this.grantType,
      @JsonKey(name: BodySecurityLogin.usernameKey_) required this.username,
      @JsonKey(name: BodySecurityLogin.passwordKey_) required this.password,
      @JsonKey(name: BodySecurityLogin.scopeKey_) this.scope = '',
      @JsonKey(name: BodySecurityLogin.clientIdKey_) this.clientId,
      @JsonKey(name: BodySecurityLogin.clientSecretKey_) this.clientSecret})
      : super._();
