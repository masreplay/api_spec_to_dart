...
mixin _$DomainModel {
  /// domain
  @JsonKey(name: DomainModel.domainKey_)
  String get domain;
...
abstract mixin class $DomainModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: DomainModel.domainKey_) String domain});
}
...
extension DomainModelPatterns on DomainModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: DomainModel.domainKey_) String domain)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _DomainModel extends DomainModel {
  const _DomainModel(
      {@JsonKey(name: DomainModel.domainKey_) required this.domain})
      : super._();
