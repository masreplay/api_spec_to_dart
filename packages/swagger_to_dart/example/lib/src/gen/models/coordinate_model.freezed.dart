...
mixin _$CoordinateModel {
  ...
  /// latitude
  @JsonKey(name: CoordinateModel.latitudeKey_)
  double? get latitude;

  /// longitude
  @JsonKey(name: CoordinateModel.longitudeKey_)
...
class _CoordinateModel extends CoordinateModel {
  const _CoordinateModel(
      {@JsonKey(name: CoordinateModel.coordinateKey_) this.coordinate,
      @JsonKey(name: CoordinateModel.latitudeKey_) this.latitude,
      @JsonKey(name: CoordinateModel.longitudeKey_) this.longitude})
      : super._();
