...
mixin _$AdvancedCollectionVariableTupleQueries {
  ...
  $AdvancedCollectionVariableTupleQueriesCopyWith<
          AdvancedCollectionVariableTupleQueries>
      get copyWith => _$AdvancedCollectionVariableTupleQueriesCopyWithImpl<
              AdvancedCollectionVariableTupleQueries>(
          this as AdvancedCollectionVariableTupleQueries, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdvancedCollectionVariableTupleQueries &&
...
abstract mixin class $AdvancedCollectionVariableTupleQueriesCopyWith<$Res> {
  factory $AdvancedCollectionVariableTupleQueriesCopyWith(
          AdvancedCollectionVariableTupleQueries value,
          $Res Function(AdvancedCollectionVariableTupleQueries) _then) =
      _$AdvancedCollectionVariableTupleQueriesCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: AdvancedCollectionVariableTupleQueries.itemsKey)
      List<String> items});
...
class _AdvancedCollectionVariableTupleQueries
    extends AdvancedCollectionVariableTupleQueries {
  const _AdvancedCollectionVariableTupleQueries(
      {@JsonKey(name: AdvancedCollectionVariableTupleQueries.itemsKey)
      required final List<String> items})
      : _items = items,
        super._();
  factory _AdvancedCollectionVariableTupleQueries.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdvancedCollectionVariableTupleQueriesCopyWith<
          _AdvancedCollectionVariableTupleQueries>
      get copyWith => __$AdvancedCollectionVariableTupleQueriesCopyWithImpl<
          _AdvancedCollectionVariableTupleQueries>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdvancedCollectionVariableTupleQueriesToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdvancedCollectionVariableTupleQueries &&
...
/// @nodoc
abstract mixin class _$AdvancedCollectionVariableTupleQueriesCopyWith<$Res>
    implements $AdvancedCollectionVariableTupleQueriesCopyWith<$Res> {
  factory _$AdvancedCollectionVariableTupleQueriesCopyWith(
          _AdvancedCollectionVariableTupleQueries value,
          $Res Function(_AdvancedCollectionVariableTupleQueries) _then) =
      __$AdvancedCollectionVariableTupleQueriesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: AdvancedCollectionVariableTupleQueries.itemsKey)
