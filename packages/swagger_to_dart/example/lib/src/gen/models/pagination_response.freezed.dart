...
mixin _$PaginationResponse<T> {
  ...
  /// total
  @JsonKey(name: PaginationResponse.totalKey_)
  int get total;

  /// page
  @JsonKey(name: PaginationResponse.pageKey_)
  int get page;

  /// perPage
  @JsonKey(name: PaginationResponse.perPageKey_)
  int get perPage;

  /// totalPages
  @JsonKey(name: PaginationResponse.totalPagesKey_)
  int get totalPages;
...
abstract mixin class $PaginationResponseCopyWith<T, $Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: PaginationResponse.totalKey_) int total,
      @JsonKey(name: PaginationResponse.pageKey_) int page,
      @JsonKey(name: PaginationResponse.perPageKey_) int perPage,
      @JsonKey(name: PaginationResponse.totalPagesKey_) int totalPages});
}
...
class _PaginationResponse<T> extends PaginationResponse<T> {
  const _PaginationResponse(
      ...
      @JsonKey(name: PaginationResponse.totalKey_) required this.total,
      @JsonKey(name: PaginationResponse.pageKey_) required this.page,
      @JsonKey(name: PaginationResponse.perPageKey_) required this.perPage,
      @JsonKey(name: PaginationResponse.totalPagesKey_)
