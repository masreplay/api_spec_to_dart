...
mixin _$UlidModel {
  /// ulid
  @JsonKey(name: UlidModel.ulidKey_)
  dynamic get ulid;
...
abstract mixin class $UlidModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: UlidModel.ulidKey_) dynamic ulid});
}
...
extension UlidModelPatterns on UlidModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: UlidModel.ulidKey_) dynamic ulid)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
  ...
  TResult when<TResult extends Object?>(
    TResult Function(@JsonKey(name: UlidModel.ulidKey_) dynamic ulid) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _UlidModel():
...
class _UlidModel extends UlidModel {
  const _UlidModel({@JsonKey(name: UlidModel.ulidKey_) required this.ulid})
      : super._();
