...
abstract mixin class $BasicBasicBooleanQueryParametersCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: BasicBasicBooleanQueryParameters.flagKey_) bool flag});
}
...
/// Adds pattern-matching-related methods to [BasicBasicBooleanQueryParameters].
extension BasicBasicBooleanQueryParametersPatterns
    on BasicBasicBooleanQueryParameters {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BasicBasicBooleanQueryParameters value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _BasicBasicBooleanQueryParameters() when $default != null:
  ...
  TResult map<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _BasicBasicBooleanQueryParameters():
        return $default(_that);
      case _:
