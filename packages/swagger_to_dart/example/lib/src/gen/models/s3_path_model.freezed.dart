...
mixin _$S3PathModel {
  /// s3Path
  @JsonKey(name: S3PathModel.s3PathKey_)
  String get s3Path;
...
abstract mixin class $S3PathModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: S3PathModel.s3PathKey_) String s3Path});
}
...
extension S3PathModelPatterns on S3PathModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: S3PathModel.s3PathKey_) String s3Path)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _S3PathModel extends S3PathModel {
  const _S3PathModel(
      {@JsonKey(name: S3PathModel.s3PathKey_) required this.s3Path})
      : super._();
