...
mixin _$BodyFilesFormBasic {
  /// username
  @JsonKey(name: BodyFilesFormBasic.usernameKey_)
  String get username;

  /// password
  @JsonKey(name: BodyFilesFormBasic.passwordKey_)
  String get password;
...
abstract mixin class $BodyFilesFormBasicCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: BodyFilesFormBasic.usernameKey_) String username,
      @JsonKey(name: BodyFilesFormBasic.passwordKey_) String password,
      @JsonKey(name: BodyFilesFormBasic.rememberKey_) bool remember});
}
...
class _BodyFilesFormBasic extends BodyFilesFormBasic {
  const _BodyFilesFormBasic(
      {@JsonKey(name: BodyFilesFormBasic.usernameKey_) required this.username,
      @JsonKey(name: BodyFilesFormBasic.passwordKey_) required this.password,
      @JsonKey(name: BodyFilesFormBasic.rememberKey_) this.remember = false})
      : super._();
