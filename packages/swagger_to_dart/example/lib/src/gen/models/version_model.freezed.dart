...
mixin _$VersionModel {
  /// version
  @JsonKey(name: VersionModel.versionKey_)
  String get version;
...
abstract mixin class $VersionModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: VersionModel.versionKey_) String version});
}
...
extension VersionModelPatterns on VersionModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: VersionModel.versionKey_) String version)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _VersionModel extends VersionModel {
  const _VersionModel(
      {@JsonKey(name: VersionModel.versionKey_) required this.version})
      : super._();
