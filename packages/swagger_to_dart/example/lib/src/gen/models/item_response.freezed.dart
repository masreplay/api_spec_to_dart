...
mixin _$ItemResponse {
  /// id
  @JsonKey(name: ItemResponse.idKey_)
  int get id;

  /// name
  @JsonKey(name: ItemResponse.nameKey_)
  String get name;
...
abstract mixin class $ItemResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: ItemResponse.idKey_) int id,
      @JsonKey(name: ItemResponse.nameKey_) String name});
}
...
extension ItemResponsePatterns on ItemResponse {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: ItemResponse.idKey_) int id,
            @JsonKey(name: ItemResponse.nameKey_) String name)?
        $default, {
    required TResult orElse(),
  }) {
...
class _ItemResponse extends ItemResponse {
  const _ItemResponse(
      {@JsonKey(name: ItemResponse.idKey_) required this.id,
      @JsonKey(name: ItemResponse.nameKey_) required this.name})
      : super._();
