...
mixin _$AdvancedCollectionTupleQueries {
  ...
  $AdvancedCollectionTupleQueriesCopyWith<AdvancedCollectionTupleQueries>
      get copyWith => _$AdvancedCollectionTupleQueriesCopyWithImpl<
              AdvancedCollectionTupleQueries>(
          this as AdvancedCollectionTupleQueries, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdvancedCollectionTupleQueries &&
...
abstract mixin class $AdvancedCollectionTupleQueriesCopyWith<$Res> {
  factory $AdvancedCollectionTupleQueriesCopyWith(
          AdvancedCollectionTupleQueries value,
          $Res Function(AdvancedCollectionTupleQueries) _then) =
      _$AdvancedCollectionTupleQueriesCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: AdvancedCollectionTupleQueries.itemsKey)
      List<dynamic> items});
...
class _AdvancedCollectionTupleQueries extends AdvancedCollectionTupleQueries {
  const _AdvancedCollectionTupleQueries(
      {@JsonKey(name: AdvancedCollectionTupleQueries.itemsKey)
      required final List<dynamic> items})
      : _items = items,
        super._();
  factory _AdvancedCollectionTupleQueries.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdvancedCollectionTupleQueriesCopyWith<_AdvancedCollectionTupleQueries>
      get copyWith => __$AdvancedCollectionTupleQueriesCopyWithImpl<
          _AdvancedCollectionTupleQueries>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdvancedCollectionTupleQueriesToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdvancedCollectionTupleQueries &&
...
/// @nodoc
abstract mixin class _$AdvancedCollectionTupleQueriesCopyWith<$Res>
    implements $AdvancedCollectionTupleQueriesCopyWith<$Res> {
  factory _$AdvancedCollectionTupleQueriesCopyWith(
          _AdvancedCollectionTupleQueries value,
          $Res Function(_AdvancedCollectionTupleQueries) _then) =
      __$AdvancedCollectionTupleQueriesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: AdvancedCollectionTupleQueries.itemsKey)
