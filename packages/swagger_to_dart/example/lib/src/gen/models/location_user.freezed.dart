...
LocationUser _$LocationUserFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    case 'user':
      return LocationUserUser.fromJson(json);
    case 'location':
...
class LocationUserUser extends LocationUser {
  ...
  $LocationUserUserCopyWith<LocationUserUser> get copyWith =>
      _$LocationUserUserCopyWithImpl<LocationUserUser>(this, _$identity);
