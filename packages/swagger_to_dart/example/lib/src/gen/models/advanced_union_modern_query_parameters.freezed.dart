...
mixin _$AdvancedUnionModernQueryParameters {
  /// value
  @JsonKey(name: AdvancedUnionModernQueryParameters.valueKey_)
  dynamic? get value;
...
/// Adds pattern-matching-related methods to [AdvancedUnionModernQueryParameters].
extension AdvancedUnionModernQueryParametersPatterns
    on AdvancedUnionModernQueryParameters {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdvancedUnionModernQueryParameters value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AdvancedUnionModernQueryParameters() when $default != null:
...
class _AdvancedUnionModernQueryParameters
  ...
  const _AdvancedUnionModernQueryParameters(
      {@JsonKey(name: AdvancedUnionModernQueryParameters.valueKey_) this.value})
      : super._();
