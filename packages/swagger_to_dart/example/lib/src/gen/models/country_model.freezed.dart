...
mixin _$CountryModel {
  /// alpha2
  @JsonKey(name: CountryModel.alpha2Key_)
  String? get alpha2;

  /// alpha3
  @JsonKey(name: CountryModel.alpha3Key_)
  String? get alpha3;

  /// numeric
  @JsonKey(name: CountryModel.numericKey_)
  String? get numeric;

  /// shortName
  @JsonKey(name: CountryModel.shortNameKey_)
...
class _CountryModel extends CountryModel {
  const _CountryModel(
      {@JsonKey(name: CountryModel.alpha2Key_) this.alpha2,
      @JsonKey(name: CountryModel.alpha3Key_) this.alpha3,
      @JsonKey(name: CountryModel.numericKey_) this.numeric,
      @JsonKey(name: CountryModel.shortNameKey_) this.shortName})
      : super._();
