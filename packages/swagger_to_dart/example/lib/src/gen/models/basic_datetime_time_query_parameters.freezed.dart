...
mixin _$BasicDatetimeTimeQueryParameters {
  /// t
  @JsonKey(name: BasicDatetimeTimeQueryParameters.tKey_)
  TimeOfDay get t;
...
abstract mixin class $BasicDatetimeTimeQueryParametersCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: BasicDatetimeTimeQueryParameters.tKey_) TimeOfDay t});
}
...
class _BasicDatetimeTimeQueryParameters
  ...
  const _BasicDatetimeTimeQueryParameters(
      {@JsonKey(name: BasicDatetimeTimeQueryParameters.tKey_) required this.t})
      : super._();
