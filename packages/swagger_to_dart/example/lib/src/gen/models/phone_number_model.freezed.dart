...
mixin _$PhoneNumberModel {
  /// phone
  @JsonKey(name: PhoneNumberModel.phoneKey_)
  String get phone;

  /// phone2
  @JsonKey(name: PhoneNumberModel.phone2Key_)
  String get phone2;
...
abstract mixin class $PhoneNumberModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: PhoneNumberModel.phoneKey_) String phone,
      @JsonKey(name: PhoneNumberModel.phone2Key_) String phone2});
}
...
extension PhoneNumberModelPatterns on PhoneNumberModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: PhoneNumberModel.phoneKey_) String phone,
            @JsonKey(name: PhoneNumberModel.phone2Key_) String phone2)?
        $default, {
    required TResult orElse(),
  }) {
...
class _PhoneNumberModel extends PhoneNumberModel {
  const _PhoneNumberModel(
      {@JsonKey(name: PhoneNumberModel.phoneKey_) required this.phone,
      @JsonKey(name: PhoneNumberModel.phone2Key_) required this.phone2})
      : super._();
