...
mixin _$AdvancedDependsQueryQueryParameters {
  /// q
  @JsonKey(name: AdvancedDependsQueryQueryParameters.qKey_)
  String? get q;
...
abstract mixin class $AdvancedDependsQueryQueryParametersCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: AdvancedDependsQueryQueryParameters.skipKey_) int skip,
      @JsonKey(name: AdvancedDependsQueryQueryParameters.limitKey_) int limit});
}
...
class _AdvancedDependsQueryQueryParameters
  ...
  const _AdvancedDependsQueryQueryParameters(
      {@JsonKey(name: AdvancedDependsQueryQueryParameters.qKey_) this.q,
      @JsonKey(name: AdvancedDependsQueryQueryParameters.skipKey_)
      this.skip = 0,
      @JsonKey(name: AdvancedDependsQueryQueryParameters.limitKey_)
      this.limit = 100})
