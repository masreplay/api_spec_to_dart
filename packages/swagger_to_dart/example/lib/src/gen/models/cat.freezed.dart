...
/// name
@JsonKey(name: Cat.nameKey) String get name;/// typeAA
@JsonKey(name: Cat.typeAAKey) String get typeAA;/// meowCuteness
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Cat&&(identical(other.name, name) || other.name == name)&&(identical(other.typeAA, typeAA) || other.typeAA == typeAA)&&(identical(other.meowCuteness, meowCuteness) || other.meowCuteness == meowCuteness));
}
...
@useResult
$Res call({
@JsonKey(name: Cat.nameKey) String name,@JsonKey(name: Cat.typeAAKey) String typeAA,@JsonKey(name: Cat.meowCutenessKey) int meowCuteness
});
...
/// Create a copy of Cat
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? typeAA = null,Object? meowCuteness = null,}) {
...
class _Cat extends Cat {
  const _Cat({@JsonKey(name: Cat.nameKey) required this.name, @JsonKey(name: Cat.typeAAKey) this.typeAA = 'cat', @JsonKey(name: Cat.meowCutenessKey) required this.meowCuteness}): super._();
  factory _Cat.fromJson(Map<String, dynamic> json) => _$CatFromJson(json);

/// name
@override@JsonKey(name: Cat.nameKey) final  String name;
/// typeAA
@override@JsonKey(name: Cat.typeAAKey) final  String typeAA;
/// meowCuteness
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Cat&&(identical(other.name, name) || other.name == name)&&(identical(other.typeAA, typeAA) || other.typeAA == typeAA)&&(identical(other.meowCuteness, meowCuteness) || other.meowCuteness == meowCuteness));
}
...
/// Create a copy of Cat
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? typeAA = null,Object? meowCuteness = null,}) {
  return _then(_Cat(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,typeAA: null == typeAA ? _self.typeAA : typeAA // ignore: cast_nullable_to_non_nullable
as String,meowCuteness: null == meowCuteness ? _self.meowCuteness : meowCuteness // ignore: cast_nullable_to_non_nullable
