...
mixin _$ValidationError {
  /// loc
  @JsonKey(name: ValidationError.locKey_)
  List<dynamic> get loc;

  /// msg
  @JsonKey(name: ValidationError.msgKey_)
  String get msg;

  /// type
  @JsonKey(name: ValidationError.typeKey_)
  String get type;
...
abstract mixin class $ValidationErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: ValidationError.locKey_) List<dynamic> loc,
      @JsonKey(name: ValidationError.msgKey_) String msg,
      @JsonKey(name: ValidationError.typeKey_) String type});
}
...
class _ValidationError extends ValidationError {
  const _ValidationError(
      {@JsonKey(name: ValidationError.locKey_) required final List<dynamic> loc,
      @JsonKey(name: ValidationError.msgKey_) required this.msg,
      @JsonKey(name: ValidationError.typeKey_) required this.type})
      : _loc = loc,
        super._();
