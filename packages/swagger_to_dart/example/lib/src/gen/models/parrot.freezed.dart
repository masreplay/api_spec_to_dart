...
mixin _$Parrot {
  /// name
  @JsonKey(name: Parrot.nameKey_)
  String get name;

  /// type
  @JsonKey(name: Parrot.typeKey_)
  String get type;

  /// phrases
  @JsonKey(name: Parrot.phrasesKey_)
...
abstract mixin class $ParrotCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: Parrot.nameKey_) String name,
      @JsonKey(name: Parrot.typeKey_) String type,
      @JsonKey(name: Parrot.phrasesKey_) List<String> phrases});
}
...
class _Parrot extends Parrot {
  const _Parrot(
      {@JsonKey(name: Parrot.nameKey_) required this.name,
      @JsonKey(name: Parrot.typeKey_) this.type = 'parrot',
      @JsonKey(name: Parrot.phrasesKey_) required final List<String> phrases})
      : _phrases = phrases,
        super._();
