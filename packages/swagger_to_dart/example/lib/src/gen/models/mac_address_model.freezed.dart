...
mixin _$MACAddressModel {
  /// macAddress
  @JsonKey(name: MACAddressModel.macAddressKey_)
...
abstract mixin class $MACAddressModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: MACAddressModel.macAddressKey_) String macAddress});
}
...
extension MACAddressModelPatterns on MACAddressModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            @JsonKey(name: MACAddressModel.macAddressKey_) String macAddress)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _MACAddressModel extends MACAddressModel {
  const _MACAddressModel(
      {@JsonKey(name: MACAddressModel.macAddressKey_) required this.macAddress})
      : super._();
