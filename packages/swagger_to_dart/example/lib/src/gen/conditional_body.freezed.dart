...
$ConditionalBodyCopyWith<ConditionalBody> get copyWith => _$ConditionalBodyCopyWithImpl<ConditionalBody>(this as ConditionalBody, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ConditionalBody&&(identical(other.itemId, itemId) || other.itemId == itemId)&&(identical(other.itemName, itemName) || other.itemName == itemName));
}
...
/// Create a copy of ConditionalBody
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? itemId = freezed,Object? itemName = freezed,}) {
...
@pragma('vm:prefer-inline')
_$ConditionalBodyCopyWith<_ConditionalBody> get copyWith => __$ConditionalBodyCopyWithImpl<_ConditionalBody>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ConditionalBody&&(identical(other.itemId, itemId) || other.itemId == itemId)&&(identical(other.itemName, itemName) || other.itemName == itemName));
}
...
/// @nodoc
abstract mixin class _$ConditionalBodyCopyWith<$Res> implements $ConditionalBodyCopyWith<$Res> {
...
/// Create a copy of ConditionalBody
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? itemId = freezed,Object? itemName = freezed,}) {
