...
$ItemRequestBodyCopyWith<ItemRequestBody> get copyWith => _$ItemRequestBodyCopyWithImpl<ItemRequestBody>(this as ItemRequestBody, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ItemRequestBody&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.price, price) || other.price == price)&&(identical(other.tax, tax) || other.tax == tax));
}
...
abstract mixin class $ItemRequestBodyCopyWith<$Res>  {
  factory $ItemRequestBodyCopyWith(ItemRequestBody value, $Res Function(ItemRequestBody) _then) = _$ItemRequestBodyCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: ItemRequestBody.nameKey) String name,@JsonKey(name: ItemRequestBody.descriptionKey) String? description,@JsonKey(name: ItemRequestBody.priceKey) double price,@JsonKey(name: ItemRequestBody.taxKey) double? tax
});
...
/// Create a copy of ItemRequestBody
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = freezed,Object? price = null,Object? tax = freezed,}) {
...
@pragma('vm:prefer-inline')
_$ItemRequestBodyCopyWith<_ItemRequestBody> get copyWith => __$ItemRequestBodyCopyWithImpl<_ItemRequestBody>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ItemRequestBody&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.price, price) || other.price == price)&&(identical(other.tax, tax) || other.tax == tax));
}
...
/// @nodoc
abstract mixin class _$ItemRequestBodyCopyWith<$Res> implements $ItemRequestBodyCopyWith<$Res> {
  factory _$ItemRequestBodyCopyWith(_ItemRequestBody value, $Res Function(_ItemRequestBody) _then) = __$ItemRequestBodyCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: ItemRequestBody.nameKey) String name,@JsonKey(name: ItemRequestBody.descriptionKey) String? description,@JsonKey(name: ItemRequestBody.priceKey) double price,@JsonKey(name: ItemRequestBody.taxKey) double? tax
});
...
/// Create a copy of ItemRequestBody
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = freezed,Object? price = null,Object? tax = freezed,}) {
