...
$BodySecurityLoginCopyWith<BodySecurityLogin> get copyWith => _$BodySecurityLoginCopyWithImpl<BodySecurityLogin>(this as BodySecurityLogin, _$identity);
...
abstract mixin class $BodySecurityLoginCopyWith<$Res>  {
  factory $BodySecurityLoginCopyWith(BodySecurityLogin value, $Res Function(BodySecurityLogin) _then) = _$BodySecurityLoginCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: BodySecurityLogin.grantTypeKey) String? grantType,@JsonKey(name: BodySecurityLogin.usernameKey) String username,@JsonKey(name: BodySecurityLogin.passwordKey) String password,@JsonKey(name: BodySecurityLogin.scopeKey) String scope,@JsonKey(name: BodySecurityLogin.clientIdKey) String? clientId,@JsonKey(name: BodySecurityLogin.clientSecretKey) String? clientSecret
});
...
@pragma('vm:prefer-inline')
_$BodySecurityLoginCopyWith<_BodySecurityLogin> get copyWith => __$BodySecurityLoginCopyWithImpl<_BodySecurityLogin>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BodySecurityLogin&&(identical(other.grantType, grantType) || other.grantType == grantType)&&(identical(other.username, username) || other.username == username)&&(identical(other.password, password) || other.password == password)&&(identical(other.scope, scope) || other.scope == scope)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.clientSecret, clientSecret) || other.clientSecret == clientSecret));
}
...
/// @nodoc
abstract mixin class _$BodySecurityLoginCopyWith<$Res> implements $BodySecurityLoginCopyWith<$Res> {
  factory _$BodySecurityLoginCopyWith(_BodySecurityLogin value, $Res Function(_BodySecurityLogin) _then) = __$BodySecurityLoginCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: BodySecurityLogin.grantTypeKey) String? grantType,@JsonKey(name: BodySecurityLogin.usernameKey) String username,@JsonKey(name: BodySecurityLogin.passwordKey) String password,@JsonKey(name: BodySecurityLogin.scopeKey) String scope,@JsonKey(name: BodySecurityLogin.clientIdKey) String? clientId,@JsonKey(name: BodySecurityLogin.clientSecretKey) String? clientSecret
});
