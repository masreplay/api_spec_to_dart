...
class OpenApiGeneratorConfig {
  /// Creates a [OpenApiGeneratorConfig].
  ...
  /// Internal constructor of [OpenApiGeneratorConfig]
  const OpenApiGeneratorConfig._({
    required this.outputDirectory,
  ...
  /// Creates a [OpenApiGeneratorConfig] from [YamlMap].
  factory OpenApiGeneratorConfig.fromYaml(
    YamlMap yamlMap, {
    bool isRootConfig = false,
    OpenApiGeneratorConfig? rootConfig,
  }) {
    ...
    // Default config
    final dc =
        OpenApiGeneratorConfig(name: name, outputDirectory: outputDirectory);

    return OpenApiGeneratorConfig._(
